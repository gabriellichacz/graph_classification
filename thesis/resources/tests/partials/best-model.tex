W wyniku testów wyłoniony został model o~najlepszej dokładności realnej,
...
% \begin{figure}[ht]
% 	\centering
% 	\includegraphics[width=15.5cm]{resources/tests/images/v4/base6_1_txt.png}
...
% \begin{figure}[ht]
% 	\centering
% 	\includegraphics[width=15.5cm]{resources/tests/images/v4/base6_1_bar.png}
