...
% \begin{figure}[ht]
% 	\centering
% 	\includegraphics[width=14cm]{resources/tests/images/v2/base4_txt.png}
...
% \begin{figure}[ht]
% 	\centering
% 	\includegraphics[width=14cm]{resources/tests/images/v2/base5_txt.png}
...
% \begin{figure}[ht]
% 	\centering
% 	\includegraphics[width=14cm]{resources/tests/images/v2/base6_txt.png}
...
% \begin{figure}[ht]
% 	\centering
% 	\includegraphics[width=14cm]{resources/tests/images/v2/base7_txt.png}
...
% -- TO DO -- % idk something delete maybe
