\textbf{Wersja podstawowa modelu ze zmienną liczbą wierzchołków}
...
\textbf{Zmodyfikowany model ze zmienną liczbą wierzchołków - Conv2D i Droput oraz spowolnienie uczenia}
...
\textbf{Zmodyfikowany model ze zmienną liczbą wierzchołków - modyfikacje połączone}
