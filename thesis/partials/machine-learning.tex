...
\textbf{Definicja \mlDefinitionIndex.}
\incrementMlDefinitionIndex
Warstwa Dense (pl. w pełni połączona) najczęściej zawiera bardzo dużo parametrów.
Dzięki temu model uzyskuje swobodę w dopasowaniu do danych uczących,
ale jednocześnie grozi mu ryzyko przetrenowania,
