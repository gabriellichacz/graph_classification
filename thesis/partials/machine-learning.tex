...
\begin{figure}[ht]
	\centering
	\includegraphics[width=8cm]{partials/images/machine_learning_def_relu.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=6cm]{partials/images/machine_learning_def_relu.png} % TO DO ---- Change
	\caption{Zobrazowanie przeuczenie modelu}
    \label{Fig:def-2}
\end{figure}
